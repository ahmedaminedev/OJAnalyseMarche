          ...
          <div className="flex items-center gap-2">
            <h4 className="text-sm font-bold text-white tracking-tight">
              {hasBlockingErrors
                ...
                : 'Prêt pour l’enregistrement dans la base locale'}
            </h4>
            <span className="px-2 py-0.5 rounded-full text-[10px] font-semibold border bg-emerald-950/70 text-emerald-300 border-emerald-700/60">
              Base Locale
            </span>
          </div>
          <p className="text-xs text-slate-400 mt-0.5">
            {hasBlockingErrors
              ...
              : `${sheetAnalysis.rowCount.toLocaleString(
                  'fr-FR'
                )} lignes et ${sheetAnalysis.columnCount} colonnes seront sauvegardées dans la base locale ${databaseName}.`}
          </p>
        </div>
      </div>
